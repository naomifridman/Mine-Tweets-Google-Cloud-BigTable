...
The file with the actual comands in cluster.sh. The actual gcloud command, writen below, spins up, by default, 4 n1-standard-4 worker nodes and a single n1-standard-4 node.<br>
Edit the following part of cluster.sh file to suit your number of workers and cpu's you choose when created the instance. 
```
